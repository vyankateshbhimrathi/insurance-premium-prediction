...
class ModelEvaluation:
    ...
    def get_best_model(self):
        ...
        try:
            model = None
            model_evaluation_path = self.model_evaluation_config.model_evaluation_path

            if not os.path.exists(model_evaluation_path):
                write_yaml_file(file_path=model_evaluation_path)

                return model

            model_eval_file_content = read_yaml_file(file_path=model_evaluation_path)
    ...
    def update_evaluation_report(self, model_evaluation_artifact:ModelEvaluationArtifact):
        try:
            eval_file_path = self.model_evaluation_config.model_evaluation_path
