...
from insurance.entity.model_factory import GridSearchedBestModel, MetricInfoArtifact
from insurance.entity.model_factory import ModelFactory, evaluate_regression_model
from insurance.util.util import load_numpy_array_data, load_object, save_object
    ...
    def initiate_model_trainer(self)-> ModelTrainerArtifact:
        try:
            ...
            model_trainer_artifact = ModelTrainerArtifact(trained_model_file_path=trained_model_file_path,
                                    ...
                                    model_accuracy=metric_info.model_acccuracy)
